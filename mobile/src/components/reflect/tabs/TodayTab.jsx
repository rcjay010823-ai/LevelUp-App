...
export const TodayTab = ({
  ...
  const timezone = getDisplayTimezone().replace(/_/g, " ");
  const currentTime = formatDateWithTimezone(new Date(), "h:mm a");
    ...
    <View style={{ padding: 20 }}>
        ...
        <View style={{ marginBottom: 20 }}>
          ...
          {activeAffirmation ? (
            ...
            >
              ...
              >
                No Power Statement selected for today
              </Text>
            </View>
          )}
        </View>
      ...
      >
        <View style={{ marginBottom: 20 }}>
          ...
          >
            Choose from our curated library or create your own personal
            statements for a boost.
          </Text>
        </View>
